...
use AGS\FinanceiroBundle\Entity\Estado;
use AGS\FinanceiroBundle\Form\EstadoType;
...
class EstadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FinanceiroBundle:Estado')->findAll();

        return $this->render('FinanceiroBundle:Estado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FinanceiroBundle:Estado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FinanceiroBundle:Estado')->find($id);
        ...
        return $this->render('FinanceiroBundle:Estado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FinanceiroBundle:Estado:edit.html.twig', array(
            'entity'      => $entity,

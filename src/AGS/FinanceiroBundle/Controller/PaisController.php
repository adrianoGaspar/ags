...
use AGS\FinanceiroBundle\Entity\Pais;
use AGS\FinanceiroBundle\Form\PaisType;
...
class PaisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FinanceiroBundle:Pais')->findAll();

        return $this->render('FinanceiroBundle:Pais:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FinanceiroBundle:Pais:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FinanceiroBundle:Pais')->find($id);
        ...
        return $this->render('FinanceiroBundle:Pais:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FinanceiroBundle:Pais:edit.html.twig', array(
            'entity'      => $entity,
